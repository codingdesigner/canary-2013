...
?>
<figure id="<?php print $id; ?>" class="<?php print $classes ?>"<?php print $attributes; ?>>

  <?php if ($view_mode == 'media_link'): ?>
    <a href="<?php print $file_url; ?>" class="linked-image"><?php print render($content['file']); ?></a>
  <?php else: ?>
    <?php print render($content['file']); ?>
  <?php endif; ?>

  <?php
    if (isset($content['field_file_image_title_text']) || isset($content['field_caption'])):
  ?>
  <figcaption>
    <?php print render($content['field_file_image_title_text']); ?>
